...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("AppstoreAppDemos.GenericFileDocument", mendixObject.getType()))
			return appstoreappdemos.proxies.GenericFileDocument.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SprintrApis2.HTMLfile", mendixObject.getType()))
