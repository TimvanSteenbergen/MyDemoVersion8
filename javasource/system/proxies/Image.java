...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("Barcode.Barcode", mendixObject.getType()))
		...
		if (com.mendix.core.Core.isSubClassOf("DomDAL.Flag", mendixObject.getType()))
			return domdal.proxies.Flag.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("PersonsWithSingleUserAccount.IdentityDocument", mendixObject.getType()))
			return personswithsingleuseraccount.proxies.IdentityDocument.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("AppstoreAppDemos.Image", mendixObject.getType()))
			return appstoreappdemos.proxies.Image.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("DragAndDropTrial.Image", mendixObject.getType()))
			return draganddroptrial.proxies.Image.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("test.ImageProduct", mendixObject.getType()))
			return test.proxies.ImageProduct.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("PersonsWithSingleUserAccount.ProfileImage", mendixObject.getType()))
