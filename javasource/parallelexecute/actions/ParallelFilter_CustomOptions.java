 ...
 */
public class ParallelFilter_CustomOptions extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public ParallelFilter_CustomOptions(IContext context, java.util.List<IMendixObject> List_, java.lang.String Microflow_, IMendixObject Options_)
	{
		super(context);
		this.List_ = List_;
	...
	{
		return "ParallelFilter_CustomOptions";
	}
